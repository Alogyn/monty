...
void sub_nodes(stacknodes_t **stack, unsigned int line_number)
{
	int difference;
...
void div_nodes(stacknodes_t **stack, unsigned int line_number)
{
	int quotient;
...
void swap_nodes(stacknodes_t **stack, unsigned int line_number)
{
	stacknodes_t *tmp;
